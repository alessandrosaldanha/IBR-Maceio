...
- Name: e2e.spec.js >> Navegação do Site IBR >> 10. Copia chave Pix na página transparência
- Location: src\test\e2e.spec.js:66:3
...
Call log:
  - waiting for locator('text=Transparência')
